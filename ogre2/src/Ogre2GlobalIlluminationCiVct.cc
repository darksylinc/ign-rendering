...
#include "ignition/rendering/ogre2/Ogre2GlobalIlluminationCiVct.hh"
...
class DETAIL_IGNITION_RENDERING_OGRE2_HIDDEN
  ignition::rendering::Ogre2CiVctCascadePrivate
{
  // clang-format off
...
class DETAIL_IGNITION_RENDERING_OGRE2_HIDDEN
  ignition::rendering::Ogre2GlobalIlluminationCiVctPrivate
{
  // clang-format off
...
//////////////////////////////////////////////////
ignition::math::Vector3d Ogre2CiVctCascade::CameraStepSize() const
{
...
void Ogre2GlobalIlluminationCiVct::SetEnabled(bool _enabled)
{
  ...
  if (_enabled)
  {
    ...
    IGN_ASSERT(hlmsPbs->getVctLighting() == nullptr ||
...
{
  IGN_ASSERT(this->dataPtr->cascadedVoxelizer->getNumCascades() != 0u &&
               this->dataPtr->cascadedVoxelizer->getVctLighting(0u) != nullptr,
...
Ogre::HlmsPbs *Ogre2GlobalIlluminationCiVct::HlmsPbs() const
{
  ...
  IGN_ASSERT(dynamic_cast<Ogre::HlmsPbs *>(hlms),
