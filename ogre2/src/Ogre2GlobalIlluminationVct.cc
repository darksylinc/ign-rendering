...
#include "ignition/rendering/ogre2/Ogre2GlobalIlluminationVct.hh"
...
class ignition::rendering::Ogre2GlobalIlluminationVctPrivate
{
  // clang-format off
...
{
  IGN_ASSERT(this->dataPtr->vctLighting != nullptr,
