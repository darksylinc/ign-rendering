 ...
 *
 */
#ifndef IGNITION_RENDERING_OGRE2_OGRE2GLOBALILLUMINATIONVCT_HH_
#define IGNITION_RENDERING_OGRE2_OGRE2GLOBALILLUMINATIONVCT_HH_

#include "ignition/rendering/base/BaseGlobalIlluminationVct.hh"
...
namespace ignition
{
  namespace rendering
  {
    ...
    class IGNITION_RENDERING_OGRE2_VISIBLE Ogre2GlobalIlluminationVct :
