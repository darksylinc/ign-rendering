 ...
 *
 */
#ifndef IGNITION_RENDERING_OGRE2_OGRE2GLOBALILLUMINATIONCIVCT_HH_
#define IGNITION_RENDERING_OGRE2_OGRE2GLOBALILLUMINATIONCIVCT_HH_
...
namespace ignition
{
  namespace rendering
  {
    ...
    class IGNITION_RENDERING_OGRE2_VISIBLE Ogre2CiVctCascade :
      public virtual CiVctCascade
    {
      ...
      public: virtual void SetAreaHalfSize(
            const ignition::math::Vector3d &_areaHalfSize) override;

      // Documentation inherited.
      public: virtual ignition::math::Vector3d AreaHalfSize() const override;

      // Documentation inherited.
      public: virtual void SetCameraStepSize(
            const ignition::math::Vector3d &_stepSize) override;

      // Documentation inherited.
      public: virtual ignition::math::Vector3d CameraStepSize() const override;
    ...
    class IGNITION_RENDERING_OGRE2_VISIBLE Ogre2GlobalIlluminationCiVct :
