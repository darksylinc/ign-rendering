 ...
 *
 */
#ifndef IGNITION_RENDERING_BASE_BASEGLOBALILLUMINATIONVCT_HH_
#define IGNITION_RENDERING_BASE_BASEGLOBALILLUMINATIONVCT_HH_
...
namespace ignition
{
  namespace rendering
  {
    ...
    {
      IGN_ASSERT(math::isPowerOfTwo(_resolution[0]),
          "Resolution must be power of 2");
      IGN_ASSERT(math::isPowerOfTwo(_resolution[1]),
          "Resolution must be power of 2");
      IGN_ASSERT(math::isPowerOfTwo(_resolution[2]),
          "Resolution must be power of 2");
    }
    ...
    {
      IGN_ASSERT(_octants[0] > 0u, "Subdivision must be greater than 0");
      IGN_ASSERT(_octants[1] > 0u, "Subdivision must be greater than 0");
      IGN_ASSERT(_octants[2] > 0u, "Subdivision must be greater than 0");
    }
