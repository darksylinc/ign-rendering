 ...
 *
 */
#ifndef IGNITION_RENDERING_NATIVEWINDOW_HH_
#define IGNITION_RENDERING_NATIVEWINDOW_HH_
...
namespace ignition
{
  namespace rendering
  {
    ...
    //
    /// \class NativeWindow NativeWindow.hh ignition/rendering/NativeWindow.hh
    ...
    class IGNITION_RENDERING_VISIBLE NativeWindow
    {
      /// \brief Destructor
