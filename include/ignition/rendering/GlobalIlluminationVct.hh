 ...
 *
 */
#ifndef IGNITION_RENDERING_GLOBALILLUMINATIONVCT_HH_
#define IGNITION_RENDERING_GLOBALILLUMINATIONVCT_HH_
...
namespace ignition
{
  namespace rendering
  {
    ...
    /// ignition/rendering/GlobalIlluminationVct.hh
    /// \brief Implements Global Illumination using VCT (Voxel Cone Tracing)
    class IGNITION_RENDERING_VISIBLE GlobalIlluminationVct :
