 ...
 *
 */
#ifndef IGNITION_RENDERING_GLOBALILLUMINATIONCIVCT_HH_
#define IGNITION_RENDERING_GLOBALILLUMINATIONCIVCT_HH_

#include "ignition/rendering/GlobalIlluminationBase.hh"
...
namespace ignition
{
  ...
  class IGNITION_RENDERING_VISIBLE CiVctCascade
  {
    /// \brief Destructor
    ...
    public: virtual void SetCameraStepSize(
          const ignition::math::Vector3d &_stepSize) = 0;

    /// \brief Returns the camera step size
    /// \return Camera step size
    public: virtual ignition::math::Vector3d CameraStepSize() const = 0;
  };

  /// \class GlobalIlluminationCiVct GlobalIlluminationCiVct.hh
  /// ignition/rendering/GlobalIlluminationCiVct.hh
  /// \brief Implements Global Illumination using CIVCT
  /// (Cascaded Image Voxel Cone Tracing)
  class IGNITION_RENDERING_VISIBLE GlobalIlluminationCiVct :
